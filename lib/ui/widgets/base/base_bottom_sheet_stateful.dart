...
/// 基础底部对话框 Widget（有状态版本）
abstract class BaseBottomSheetStateful extends StatefulWidget {
  /// 是否可关闭（向下拖拽关闭）
  ...
  @override
  State<BaseBottomSheetStateful> createState();
}

/// 基础底部对话框状态
abstract class BaseBottomSheetState<T extends BaseBottomSheetStateful>
    extends State<T> {
  /// 构建对话框内容
  ...
  static Future<T?> show<T>({
    ...
    required BaseBottomSheetStateful bottomSheet,
